...
class EstimatedGridViewController: UIViewController, UICollectionViewDelegate {
    ...
    var data: [EstimatedItem] = [
        EstimatedItem(text: "Maecenas id erat non metus viverra semper efficitur in mauris. Morbi varius mi ex, vel mattis odio vehicula sit amet. Vestibulum non nisi bibendum", image: nil),
    ...
    private func configureHierarchy() {
        ...
        collection.register(UINib(nibName: "ListCell", bundle: nil), forCellWithReuseIdentifier: ListCell.reuseIdentifier)
